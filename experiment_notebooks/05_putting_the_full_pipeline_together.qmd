...
The learning curves show that the SVC with rbf kernel is also overfitting the training data, though the curves have not plateaued yet and and the training f1 score is falling and validation score is increasing.
...
SVC and RandomForest Classifier are overfitting the data a lot. LogisticRegression and CatBoost as much better. Compare top20 features from LogisticRegression and CatBoost
